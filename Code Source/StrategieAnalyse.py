...
class StrategieAnalyse( st.Strategie ):
    ...
    def nbUnitesAEnvoyer( self, attaquante, cellule_cible ):
        """
        Détermine le nombre d'unités à envoyer de la cellule attaquante vers une cellule_cible en fonction de l'excédent de l'attaquant et du coût de la cible. 
